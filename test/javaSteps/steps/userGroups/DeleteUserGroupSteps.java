...
public class DeleteUserGroupSteps {
    ...
    /**
     * Sends a request to delete a user group which doesn't exist.
     * @param nonExistentID The non existent user group id.
     */
    ...
    /**
     * Checks if the user group exists in the database
     */
    ...
    /**
     * Asserts that all the members are removed from the user group.
     */
