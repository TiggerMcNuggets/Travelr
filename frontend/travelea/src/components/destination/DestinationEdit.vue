...
export default {
    ...
    methods: {
        updateDestination: function() {
            destinationRepostory.updateDestination(this.$route.params.id, this.destination).then((result) => {
                console.log(result)
        }) 
    ...
    created: function() {  
        destinationRepostory.getOneDestination(this.$route.params.id).then((result) => {
