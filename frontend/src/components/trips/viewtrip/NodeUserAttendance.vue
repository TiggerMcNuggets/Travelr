        ...
        <v-tooltip top>
          <template v-slot:activator="{ on }">
            <v-chip v-if="isGoing" v-on="on" color="success lighten-5">
              <v-icon color="success" left>check_circle</v-icon>Going
            </v-chip>
          </template>
        ...
        <v-tooltip top>
          <template v-slot:activator="{ on }">
            <v-chip v-on="on" v-if="isInterested" color="amber lighten-4">
              <v-icon color="amber darken-1" left>help</v-icon>Interested
            </v-chip>
          </template>
      ...
      <v-tooltip top>
        <template v-slot:activator="{ on}">
          <v-chip v-on="on" v-if="isNotGoing" color="error lighten-5">
            <v-icon color="error" left>cancel</v-icon>Not going
          </v-chip>
        </template>
